export const CITIES = [{
        ...
        description: 'The most famous city in the world, the concrete jungle which never sleeps, the city full of dreams. It is none other than New York. Be it the Statue of Liberty, Central park or the Empire State Buildingsthis city is full of memorable sites. The city where the famous series like Friends and How I Met Your Mother were staged. Our 7 days/6 nights packages will give you a memorable trip (we guarantee!). Our tour guides are highly qualified to give you a wonderful insight about the various places.'
